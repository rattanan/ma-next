...
export function NotificationCenter() {
  ...
  useEffect(() => {
    let active = true;
    load().catch((reason) => { if (active) setError(reason instanceof Error ? reason.message : "Unable to load notifications"); }).finally(() => { if (active) setLoading(false); });
    return () => { active = false; };
  }, []);
