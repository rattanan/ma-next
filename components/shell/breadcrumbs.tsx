...
const names: Record<string, string> = { admin: "Administration", users: "Users", "audit-logs": "Audit logs", "login-history": "Login history", organization: "Organization", settings: "Settings", "master-data": "Master data", notifications: "Notifications", profile: "Profile", security: "Security", maintenance: "Maintenance" };
